...
import cartEmptyImage from '../sourses/img/empty-cart.png';
import { clearCart, removeGroupCart } from '../Redux/Actions/cart';
				...
				totalCount ? <div className="cart">
					...
					<div className="content__items">
						{addedPizzas.map((obj, index) => {
							return <CartItem
								onClickRemove={removePizzas}
								id={obj.id}
								name={obj.name}
								type={obj.type}
								totalrPrice={items[obj.id].totalPrice}
